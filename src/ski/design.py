...
################################################################################
## Form generated from reading UI file 'design_matplotlib.ui'
##
...
from PySide6.QtWidgets import (QFrame, QLabel, QMenu, QMenuBar, QStatusBar,
                               QVBoxLayout, QWidget)
...
"}")
        ...
        self.chartPlaceholderFrame.setMinimumSize(QSize(0, 520))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1200, 39))
